...
export default async function KontakPage() {
  ...
  const mapEmbedUrl = loc?.mapEmbedUrl || "https://maps.google.com/maps?q=Pondok+Pesantren+Al-Abror+Yayasan+Hidayatullah+Halmahera+Timur&t=&z=15&ie=UTF8&iwloc=&output=embed"
