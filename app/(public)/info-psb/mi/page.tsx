...
export default async function InfoPSBMIPage() {
    ...
    <div className="flex flex-col min-h-screen">
      <section className="relative pt-24 pb-16 sm:pt-32 sm:pb-20 text-white overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <Image src="/foto1.jpg" alt="Info PSB MI" fill priority className="object-cover" />
        ...
        <div className="site-shell relative z-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-8">
            ...
            <div>
              ...
              <p className="text-white/70 mt-2 text-base sm:text-lg">Madrasah Ibtidaiyah Tahun Ajaran 2026/2027</p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-4">
              ...
              <p className="text-xs text-white/60 mt-1">Madrasah Ibtidaiyah</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-4">
          ...
          <ScrollAnimation direction="up">
            <div className="max-w-3xl">
              <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl font-heading mb-4">
                Penerimaan Santri Baru - MI
              </h2>
              <div className="w-16 h-1 bg-primary mb-6" />
              <p className="text-base leading-relaxed text-muted-foreground">
                Pondok Pesantren Al-Abror membuka pendaftaran santri baru untuk jenjang Madrasah Ibtidaiyah (MI)
